...
def fn_send_input_options():
    ...
    s = {'exercise': ['Daily', '5 times a week', '4 times a week',
         ...
         'weight': ['less than 100lbs', 'around 110lbs', 'around 120lbs',
                    'around 130lbs', 'around 140lbs', 'around 150lbs',
                    'around 160lbs', 'around 170lbs', 'around 180lbs',
                    'around 190lbs', '200lbs or larger'],

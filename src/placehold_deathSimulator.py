...
def fn_send_input_options():
    ...
    """
    df = pd.read_csv('D:/MSDS_UW/stats_ML/project/death_simulator-master/data/deaths_age_gender_race_mechanism_cause.csv')
    occ_df = pd.read_csv('D:/MSDS_UW/stats_ML/project/death_simulator-master/data/job_indexed_likelihood.csv')
...
def death_simulator(collected_inputs_dict):
    ...
    """
    #load datasets
    causeOfDeath = pd.read_csv('D:/MSDS_UW/stats_ML/project/death_simulator-master/data/annualCauseofDeathProbs_age_gender_race.csv')
    deathProb = pd.read_csv('D:/MSDS_UW/stats_ML/project/death_simulator-master/data/annualDeathProbs_age_gender_race.csv')
    jobIndex = pd.read_csv('D:/MSDS_UW/stats_ML/project/death_simulator-master/data/job_indexed_likelihood.csv')
...
def fn_send_output_string(collected_inputs_dict):
    ...
    input_pdf_path = 'D:/MSDS_UW/stats_ML/project/death_simulator-master/docs/death_certificate_template.pdf'
    output_pdf_path = "D:/MSDS_UW/stats_ML/project/death_simulator-master/docs/death_certificate_{fname}.pdf".format(fname = data_dict['name'])
